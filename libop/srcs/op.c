...
/*   Updated: 2019/01/24 12:26:25 by emuckens         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_op	g_op_tab[NB_INSTRUCTIONS + 1] =
{
	...
	{"add", THREE, {T_REG, T_REG, T_REG}, ADD, 10, ADD_STR, OCP_YES,
		CARRY_YES, 0},
	{"sub", THREE, {T_REG, T_REG, T_REG}, SUB, 10, SUB_STR, OCP_YES,
		CARRY_YES, 0},
	{"and", THREE, {T_REG | T_DIR | T_IND, T_REG | T_IND | T_DIR, T_REG},
		AND, 6, AND_STR, OCP_YES, CARRY_YES, 0},
	{"or", THREE, {T_REG | T_IND | T_DIR, T_REG | T_IND | T_DIR, T_REG},
	...
	{"lld", TWO, {T_DIR | T_IND, T_REG}, LLD, 10, LLD_STR, OCP_YES,
		CARRY_YES, 0},
