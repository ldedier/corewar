...
/*   Updated: 2019/03/05 21:24:38 by emuckens         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_is_on_draggable_locals(t_vm *vm, t_ixy xy,
		int i, t_drag_container *dc)
{
	...
	if (vm->visu.local_type == LOCAL_LOCAL
			&& vm->local_player[i].relevant
			&& ft_is_on_player_scrollbar(vm, xy,
