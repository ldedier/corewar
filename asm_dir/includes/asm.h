...
/*   Updated: 2019/03/06 16:39:40 by emuckens         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
int								read_comment_continue(char *line, int i,
									t_env *env, int fd);
...
int								read_name(char *line, t_env *env, int i,
								int j);
int								check_comment(char *str, t_env *env);
int								read_comment(char *line, t_env *env, int fd,
								int i);
int								isprint(int c);
...
int								ft_populate_from_opcode(char *str, int start,
								int i, t_env *e);
...
int								ft_process_parse_param(char *param, int index,
								t_env *e);
int								ft_process_parse_direct(char *str, int index,
								t_env *e);
int								ft_process_parse_indirect(char *str, int index,
								t_env *e);
int								ft_process_parse_dir_value(char *str, int index,
								int offset, t_env *e);
int								ft_process_parse_ind_value(char *str, int index,
								int offset, t_env *e);
int								ft_process_parse_label(char *str, int index,
								int offset, t_env *e);
int								ft_nb_params_coherent(char *str, t_env *e);
int								ft_process_parse_register(char *str, int index,
								t_env *e);
int								ft_log_custom_wrong_param_type(char *arg_type,
								int index, int offset, t_env *e);
int								ft_log_custom_nb_params_error(t_env *e);
int								ft_process_populate_from_opcode(char
								*opcode_str, t_env *e);
...
int								ft_init_instruction(t_instruction *instruction,
								t_env *e);
...
int								ft_process_fill_instruction_label_value
								(t_instruction *instruction, int index,
								t_list *labels);
...
int								ft_log_no_label_error
								(t_instruction *instruction, int index,
								t_env *e);
void							ft_print_param(t_parameter param, int index);
void							ft_print_instruction(t_instruction
								*instruction);
